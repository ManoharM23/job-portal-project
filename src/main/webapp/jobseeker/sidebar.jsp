...
<aside class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="browse-jobs.jsp" class="<%= "browse-jobs.jsp".equals(activePage) ? "active" : "" %>">&#128269; Browse Jobs</a></li>
        <li><a href="my-applications.jsp" class="<%= "my-applications.jsp".equals(activePage) ? "active" : "" %>">&#128203; My Applications</a></li>
